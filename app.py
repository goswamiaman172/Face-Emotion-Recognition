...
def main():
    ...
    <h2 style="color:white;text-align:center;">Haar Cascade Object Detection</h2>
        ...
        st.write('''
                  Email:- goswamiaman172@gmail.com.
                 
                  Linkedin:-https://www.linkedin.com/in/aman-goswami-365012128/
    ...
    <h2 style="color:white;text-align:center;">Copyright © 2021 | Aman Goswami </h2>
    </div>
    </body>
        """
        st.markdown(html_temp, unsafe_allow_html=True)
